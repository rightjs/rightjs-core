...
var TestCaseUtil = {
  ...
  to_pretty_s: function(object, offsett) {
...
TestCaseUtil.Element.Selector = {
  ...
  find_all: function(elementt, css_rule) {
    var founds = [], element = TestCaseUtil.$(elementt);
...
TestCase.Mocking = {
  ...
  _run_if_mockable: function() {
    ...
    for (var i=0; i < this._mockable_libs.length; i++) {
      if (this._mockable_libs[i] in self) {
...
TestCase.AssertionsExtender = {
  add_assertion: function(namet, func) {
    var name = namet.substr(0, 7) == 'assert_' ? namet.substr(7, namet.length) : namet;
...
TestReporter.UIBuilder = TestCaseUtil.create_class({
  ...
  create_error_code_snippet: function(error_block, e, assertion_num, failed_test_codet) {
    var failed_test_code = this._paint_source_code(failed_test_codet, e, assertion_num);
