...
var Xhr = new Class(Observer, {
  ...
  initialize: function(url, options) {
    this.url = url;
    $ext(this, Object.merge(Xhr.OPTIONS, options), true);
    ...
    this.onSuccess(this.evalScripts.bind(this));
    
    if (this.spinner) {
      this.onCreate((function() { $(this.spinner).show(); }).bind(this));
      this.onComplete((function() { $(this.spinner).hide(); }).bind(this));
    }
  },
...
Observer.create(Xhr, { shorts: Xhr.EVENTS });